<template>
  <div class="app-container">
    ...
    <el-table  :data="servicechargeList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="是否转正"  prop="basicSalary" />
      <el-table-column label="请假天数"  prop="overAttence" />
      <el-table-column label="实际工资"  prop="realAttence" />
      <el-table-column label="实际出勤"  prop="projectSalary" />
      <el-table-column label="法定出勤"  prop="buzhuSalary" />
      <el-table-column label="入项实际工资"  prop="baoxianSalary" />
      <el-table-column label="全勤"  prop="realSalary" />
      <el-table-column label="保险"  prop="realSalary" />
      <el-table-column label="提成/其他"  prop="realSalary" />
