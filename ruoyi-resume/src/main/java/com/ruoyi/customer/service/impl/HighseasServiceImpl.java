...
public class HighseasServiceImpl implements IHighseasService
{
    ...
    {
        Yxdemand yxdemand= highseasMapper.selectYxdemandById(entryId);
...
//        }
        ...
        return highseasMapper.selectYxdemandList(yxdemand);
    }
    ...
    {
        return highseasMapper.updateYxdemand(yxdemand);
    }
    ...
    {
        return highseasMapper.deleteYxdemandByIds(entryIds);
    }
    ...
    {
        return highseasMapper.deleteYxdemandById(entryId);
    }
}
